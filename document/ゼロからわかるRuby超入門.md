...
- 11-5 Mac環境へ最新のRubyをインストールする
    ...
    - Rubyのバージョンを更新する
        - 新しいRubyが公開された時も、Homebrewを使って更新できます。まず、brew updateコマンドで新しいパッケージ情報を取得します。

            ```ruby
            brew update
            ```

            - 次にbrew upgrade rubyコマンドでRubyを更新します。
...
**<details><summary>おわりに</summary>**

    
- もっと学びたい方へ
    
    さらに学びたい方へ、著者が読んだ本の中から、お薦めの書籍を挙げます。気が合いそうな本を選んで読んでみてください
    
- たのしいRuby 第6版
    - Rubyの知識を幅広く学べる、Ruby入門書。改定されながら、15年以上にわたり多くの人々に読み継がれている名著です。
    
    [『たのしいRuby 第6版』サポートページ](https://tanoshiiruby.github.io/6/)
    
- かんたんRuby
    - 網羅的なRubyの知識を読みやすく丁寧に説明した入門書です。
    
    [かんたん Ruby](https://gihyo.jp/book/2018/978-4-7741-9861-3)
    
- 改訂2版 パーフェクトRuby
    - Rubyの知識をより磨き、熟練エンジニアを目指す一冊です。応用的な内容まで丁寧に書かれています。
    
    [改訂2版 パーフェクトRuby](https://gihyo.jp/book/2017/978-4-7741-8977-2)
    
- 改訂2版 Ruby逆引きハンドブック
    - 解決したい問題からプログラムを引けるレシピ集のような書籍。サンプルコードは短く簡潔で、網羅する範囲も幅広いです。
    
    [書籍詳細｜株式会社 C&R研究所](https://www.c-r.com/book/detail/1251)
    
- プロを目指す人のためのRuby入門 言語仕様からテスト駆動開発・デバック技法まで
    - 実際に仕事でつかわるる知識が書かれた、実践的な一冊。プログラムにおける慣習や、良いプログラムについても説明されています。
    
    [プロを目指す人のためのRuby入門［改訂2版］ 言語仕様からテスト駆動開発・デバッグ技法まで](https://gihyo.jp/book/2021/978-4-297-12437-3)
    
- Railsの教科書
    - 拙著のRails入門書です。こちらもプログラムが初めての方への講義をもとに書いています。Webアプリ作りを通してRailsの基礎を学べます。
    
    [Railsの教科書 - Railsチュートリアル](https://railstutorial.jp/textbook#purchase)
    
- 現場で使える Ruby on Rails 5 速習実践ガイド
    - Railsの基礎知識を網羅的に広く学ぶ一冊。タイトルの通り、原盤で使う技術を幅広く説明しています。
    
    [現場で使える Ruby on Rails 5速習実践ガイド|マイナビブックス](https://book.mynavi.jp/ec/products/detail/id=93905)
    
- 改訂2版 わかばちゃんと学ぶ Git使い方入門
    - プログラムの履歴を管理できるバージョン管理システムGitを漫画と実践で学べる入門書です。Gitは保存したある地点のプログラムを取得したり、差分を見ることができ、プログラミング生活でとても便利に使える道具です。
    
    [書籍詳細｜株式会社 C&R研究所](https://www.c-r.com/book/detail/1409)</details>
